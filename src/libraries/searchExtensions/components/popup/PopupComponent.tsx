...
export class PopupComponent extends React.Component<IPopupComponentProps, IPopupComponentState> {
    ...
    public render() {
        ...
        let _clickElement: HTMLElement|null = htmlContent.getElementById("popupclick");
        let _clickHTML = "";
        if(_clickElement) {
        ...
        let _headerElement: HTMLElement|null = htmlContent.getElementById("popupheader");
        let _headerHTML = "";
        if(_headerElement) {
        ...
        let _bodyElement: HTMLElement|null = htmlContent.getElementById("popupbody");
        let _bodyHTML = "";
        if(_bodyElement) {
